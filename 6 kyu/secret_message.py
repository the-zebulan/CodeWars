...
assert find_secret_message('thing sleeps is in, HAVE, always? in thing out is: '
                           'WANTS a! good T-Rex, is, never, sleeps good NEVER, '
                           'chocolate? Think the in Is THING? thing: Pippi? '
                           'sleeps T-Rex') == \
